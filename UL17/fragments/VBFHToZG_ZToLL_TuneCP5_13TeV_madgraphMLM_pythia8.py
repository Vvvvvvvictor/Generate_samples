...
for mh in m_higgs:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('instMG://VBFHToZG_ZToLL_TuneCP5_13TeV_madgraphMLM_pythia8/MG5_aMC_v2.6.5/%.0f' % (mh)),
            ConfigDescription = cms.string('VBFHToZG_ZToLL_M%.0f_TuneCP5_13TeV_madgraphMLM_pythia8' % (mh)),
